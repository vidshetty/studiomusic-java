package com.app.studiomusic.BottomMenu;
...
public class BottomMenu {
    ...
    private ConstraintLayout tracks_details_container = null;
    private View bottom_menu_border = null;
    ...
    private BottomMenu(Builder builder) {
        ...
        tracks_details_container = dialog.findViewById(R.id.track_details_container);
        bottom_menu_border = dialog.findViewById(R.id.bottom_menu_black_border);
    ...
    public void show() {
        ...
        if (
            ...
            tracks_details_container.setVisibility(View.GONE);
            bottom_menu_border.setVisibility(View.GONE);
        }
        else {
            ...
            tracks_details_container.setVisibility(View.VISIBLE);
            bottom_menu_border.setVisibility(View.VISIBLE);
