...
public class Albums_Adapter extends RecyclerView.Adapter<Albums_Adapter.AlbumsHolder> {

    private Context context = null;
    private List<Album> albums = null;
    private AlbumsTouch albumsTouch = null;

    public Albums_Adapter(Context context, List<Album> albums, AlbumsTouch albumsTouch) {
