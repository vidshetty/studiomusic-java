...
public class MoreSearchSongsAdapter extends RecyclerView.Adapter<MoreSearchSongsAdapter.SongsHolder> {

    private Context context = null;
    private List<Track> tracks = null;
    private SongsTouch songsTouch = null;

    public MoreSearchSongsAdapter(Context context, List<Track> tracks, SongsTouch songsTouch) {
