...
public class Queue_RecyclerView_Adapter extends RecyclerView.Adapter<Queue_RecyclerView_Adapter.QueueViewHolder> {
    ...
    public void onBindViewHolder(@NonNull QueueViewHolder holder, int position) {
        ...
        QueueTrack track = NowPlayingData.getInstance(context).getQueueTrackList().get(position);
        ...
        if (track.isNowPlaying()) {
            ...
            holder.album_art_1.setVisibility(View.GONE);
...
//
//            holder.album_art_1.setVisibility(View.GONE);
//            holder.album_art_2.setVisibility(View.VISIBLE);
//            holder.album_art_2.setImageResource(R.drawable.ic_volume_icon);
//
//        }
//        else {
//
...
//
//            holder.album_art_1.setVisibility(View.VISIBLE);
//            holder.album_art_2.setVisibility(View.GONE);
//            Glide.with(context)
//                .asBitmap()
//                .load(track.getThumbnail())
//                .into(holder.album_art_1);
...
//        }
    ...
    public int getItemCount() {
        return NowPlayingData.getInstance(context).getQueueTrackList().size();
    };
