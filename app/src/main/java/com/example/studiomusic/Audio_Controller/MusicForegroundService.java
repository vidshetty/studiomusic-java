            ...
            timeout_runnable = new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        body.put("albumId", NowPlayingData.getInstance(context).getNowPlayingTrack().getAlbumId());
...
//            mediaSession.setQueue(null);
        ...
        public void playNextMultipleTracks(List<Track> tracks) {
            ...
            for (int i=tracks.size()-1; i>=0; i--) playNext(tracks.get(i));
        };
...
//        notificationClick = PendingIntent.getActivity(getApplicationContext(), 0, intent, PendingIntent.FLAG_IMMUTABLE);
...
//            .setOngoing(true)
    ...
    private void customNotification(boolean isPlaying) {
        ...
        boolean isAndroid13orAbove = Build.VERSION.SDK_INT > Build.VERSION_CODES.S;
