...
import com.example.studiomusic.Audio_Controller.MusicForegroundService.NowPlayingData.REPEAT_TYPE;
import com.example.studiomusic.BottomMenu.BottomMenu;
import com.example.studiomusic.Common.Common;
import com.example.studiomusic.Lyrics.LyricsActivity;
import com.example.studiomusic.MusicData.Track;
import com.example.studiomusic.Queue.QueueActivity;
...
//    private TextView nowplaying_yeartext = null;
    ...
    private void createView() {
        ...
        nowplaying_track = NowPlayingData.getInstance(this).getTrack();
...
//            if (!NowPlayingData.getInstance(this).getMediaPrepared()) return;
        ...
        if (!NowPlayingData.getInstance(this).getMediaPrepared()) {
...
//        nowplaying_yeartext.setText(nowplaying_track.getYear());
        ...
        REPEAT_TYPE currentRepeatType = NowPlayingData.getInstance(getApplicationContext()).getRepeatType();
        if (currentRepeatType == REPEAT_TYPE.NO_REPEAT) nowplaying_repeat.setImageResource(R.drawable.ic_no_repeat_icon);
        else if (currentRepeatType == REPEAT_TYPE.REPEAT_CURRENT) nowplaying_repeat.setImageResource(R.drawable.ic_repeat_one_icon);
        else if (currentRepeatType == REPEAT_TYPE.REPEAT_ALL) nowplaying_repeat.setImageResource(R.drawable.ic_repeat_all_icon);
    ...
    private void shuffleAlgo(View v) {
        NowPlayingData.getInstance(this).shuffleQueue();
    ...
    private void settingRepeatType(View v) {
        ...
        if (currentRepeatType == REPEAT_TYPE.NO_REPEAT) {
            nowplaying_repeat.setImageResource(R.drawable.ic_repeat_all_icon);
            NowPlayingData.getInstance(getApplicationContext())
                .setRepeatType(REPEAT_TYPE.REPEAT_ALL);
        }
        else if (currentRepeatType == REPEAT_TYPE.REPEAT_CURRENT) {
            nowplaying_repeat.setImageResource(R.drawable.ic_no_repeat_icon);
            NowPlayingData.getInstance(getApplicationContext())
                .setRepeatType(REPEAT_TYPE.NO_REPEAT);
        }
        else if (currentRepeatType == REPEAT_TYPE.REPEAT_ALL) {
            nowplaying_repeat.setImageResource(R.drawable.ic_repeat_one_icon);
            NowPlayingData.getInstance(getApplicationContext())
                .setRepeatType(REPEAT_TYPE.REPEAT_CURRENT);
        }
